...
"""
    ...
    print(producto + " el precio por unidad es "+ precio )
...
def run():
    ...
    print('{producto}: {unidades:3d} unidades x {precio:9.2f}€ = {total:11.2f}€'.format(producto = producto, unidades = unidades, 
    precio = precio, total = unidades * precio))
